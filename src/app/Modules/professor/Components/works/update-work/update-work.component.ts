...
export class UpdateWorkComponent implements OnInit {
  ...
  initForm() {
    this.form = this._builder.group({
      ...
      subject:[this.data.subject, [Validators.required, Validators.maxLength(30)]],
      question:[this.data.question, Validators.required],
      correction:[this.data.correction, Validators.required],
      explanation:[this.data.explanation, Validators.required],
      firstHint:[this.data.firstHint, Validators.required],
      secondHint:[this.data.secondHint],
  ...
  onSubmit(){
    if (this.SpacesOnly(this.form.value['subject']) 
      ...
      this._workService.UpdateWork(work);
